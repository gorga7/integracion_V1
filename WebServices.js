...
function showResponse(responseData) {
    ...
    document.getElementById('cliente-remitente').textContent = responseData.clienteRemitente;
    document.getElementById('destinatario').textContent = responseData.destinatario;
    ...
    document.getElementById('cantidad-paquetes').textContent = responseData.cantidadPaquetes;
    document.getElementById('d-tipo-entrega').textContent = responseData.dTipoEntrega;
    document.getElementById('oficina-destino').textContent = responseData.oficinaDestino;
...
document.getElementById("ID_Sesion").value = localStorage.getItem("ID_Session") || "";
...
document.getElementById("enviar").addEventListener("click", function() {
  ...
  if (ID_Sesion) {
    ...
    fetch("https://altis-ws.grupoagencia.com:444/JAgencia/JAgencia.asmx/wsObtieneGuiasCliente", {
      method: "POST",
